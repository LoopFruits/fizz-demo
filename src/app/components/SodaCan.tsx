...
const flavorTextures = {
  lemonLime: "fonts/labels/lemon-lime.png",
  grape: "fonts/labels/grape.png",
  blackCherry: "fonts/labels/cherry.png",
  strawberryLemonade: "fonts/labels/strawberry.png",
  watermelon: "fonts/labels/watermelon.png",
};
// color of the can 
