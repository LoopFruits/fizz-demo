  ...
  return (
    ...
    >
      <h2 className="grid w-full gap-[3vw] py-10 text-center font-black uppercase leading-[0.7]">
        ...
        <div className="grid gap-[3vw] text-[34w] md:flex md:text-[11vw]">
        <span className="inline-block">that</span>
        <span className="inline-block mad-md:text-[27vw]">makes</span>
        <span className="inline-block mad-md:text-[40vw]">you</span>
        </div>
