...
export default function Scene({}: Props) {
    ...
    useGSAP(()=>{
        ...
        if (window.scrollY < 20){ // if user scrolls past 20 px image will show 
          introTl
        ...
        const scrollTl = gsap.timeline({
          ...
          scrollTrigger: { //rotates on scroll
            trigger: ".hero",
            start: "top top",
            end: "bottom bottom",
            scrub: 1.5,
        ...
        scrollTl
          //Rotate can group
          .to(groupRef.current.rotation, { y: Math.PI * 2 }) //rotating on y axis 360 degrees
